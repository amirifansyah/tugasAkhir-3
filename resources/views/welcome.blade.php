                    ...
                    <div class="wrap-login100 p-t-30 p-b-50">
                        <span class="login100-form-title p-b-41">
                            ...
                            <div class="container-login100-form-btn m-t-32">   
                                <a href="{{ route('login') }}" class="text-sm text-gray-700 underline"><button class="login100-form-btn">Log in</button></a>                                
                                <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline"><button class="login100-form-btn">Register</button></a>
                            </div>
                    </div>
                </div>
            </div>
